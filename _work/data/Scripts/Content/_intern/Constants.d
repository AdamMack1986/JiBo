...
const int STARTLEVEL_ZEN 	= 0;
const int START_ZEN 		= 1;
const int LEVEL01_ZEN 		= 2;
const int LEVEL02_ZEN		= 3;
const int LEVEL03_ZEN		= 4;
const int LEVEL04_ZEN		= 5;
const int LEVEL05_ZEN		= 6;
const int LEVEL06_ZEN		= 7;
const int LEVEL07_ZEN		= 8;
const int LEVEL08_ZEN		= 9;
const int LEVEL09_ZEN		= 10;
const int LEVEL10_ZEN		= 11;
const int LEVEL11_ZEN		= 12;
const int LEVEL12_ZEN		= 13;
const int LEVEL13_ZEN		= 14;

...
INSTANCE 		JIBOTELEPORT					(C_SFX_DEF)		{file="JIBOTELEPORT.wav";							vol=127;						};
INSTANCE 		JIBOJUMP					(C_SFX_DEF)		{file="JIBOJUMP.wav";							vol=127;						};
INSTANCE 		JIBOWACKELDACKEL					(C_SFX_DEF)		{file="JIBOWACKELDACKEL.wav";							vol=127;					loop = 1;	};
INSTANCE 		JIBOEVERYBODYRUNS					(C_SFX_DEF)		{file="JIBOEVERYBODYRUNS.wav";							vol=127;					loop = 1;	};
INSTANCE 		JIBOWOLKENWELT					(C_SFX_DEF)		{file="JIBOWOLKENWELT.wav";							vol=127;					loop = 1;	};
INSTANCE 		JIBOCATCHME					(C_SFX_DEF)		{file="JIBOCATCHME.wav";							vol=127;						};
INSTANCE 		JIBOWASSERMARSCH					(C_SFX_DEF)		{file="JIBOWASSERMARSCH.wav";							vol=127;					loop = 1;	};
INSTANCE 		JIBOMUKKE					(C_SFX_DEF)		{file="JIBOMUKKE.wav";							vol=127;					loop = 1;	};
INSTANCE 		JIBOZERMATSCHEN					(C_SFX_DEF)		{file="JIBOZERMATSCHEN.wav";							vol=127;						};
INSTANCE 		JIBOLUFT					(C_SFX_DEF)		{file="JIBOLUFT.wav";							vol=127;						};

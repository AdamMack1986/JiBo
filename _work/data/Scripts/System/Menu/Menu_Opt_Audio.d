...
INSTANCE MENU_OPT_AUDIO(C_MENU_DEF)
{
	...
	items[5]		= "MENUITEM_AUDIO_PROVIDER";
	items[6]		= "MENUITEM_AUDIO_PROVIDER_CHOICE";

	items[7]		= "MENUITEM_AUDIO_SPEEKER";
	items[8]		= "MENUITEM_AUDIO_SPEEKER_CHOICE";

	items[9]		= "MENUITEM_AUDIO_REVERB";
	items[10]		= "MENUITEM_AUDIO_REVERB_CHOICE";

	items[11]		= "MENUITEM_AUDIO_REVERB_SPEECH";
	items[12]		= "MENUITEM_AUDIO_REVERB_SPEECH_CHOICE";

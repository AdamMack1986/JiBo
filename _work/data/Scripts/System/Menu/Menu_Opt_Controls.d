...
instance MENU_OPT_CONTROLS(C_MENU_DEF)
{
	...
	items[14]		= "MENU_ITEM_INP_UP";
	items[15]		= "MENU_ITEM_INP_DOWN";
	items[16]		= "MENU_ITEM_INP_LEFT";
	items[17]		= "MENU_ITEM_INP_RIGHT";
	items[18]		= "MENU_ITEM_INP_STRAFE_LEFT";
	items[19]		= "MENU_ITEM_INP_STRAFE_RIGHT";
	items[20]		= "MENU_ITEM_INP_JUMPCLIMBSTRAFE";
	items[21]		= "MENU_ITEM_INP_RUNMODETOGGLE";
	items[22]		= "MENU_ITEM_INP_SNEAK";

	items[23]		= "MENU_ITEM_INP_ACTION";
	items[24]		= "MENU_ITEM_INP_WEAPON";
	items[25]		= "MENU_ITEM_INP_MAP";

	items[26]		= "MENU_ITEM_INP_LOOK";
	items[27]		= "MENU_ITEM_INP_LOOK_FP";

	items[28]		= "MENU_ITEM_INP_INVENTORY";
	items[29]		= "MENU_ITEM_INP_SCREEN_STATUS";
	items[30]		= "MENU_ITEM_INP_SCREEN_LOG";

	//

	items[31]		= "MENU_ITEM_CHG_KEYS_SET_DEFAULT";
	items[32]		= "MENU_ITEM_CHG_KEYS_SET_ALTERNATIVE";

	items[33]		= "MENUITEM_CHG_KEYS_BACK";

	items[34]		= "MENU_ITEM_NEXTMENU";

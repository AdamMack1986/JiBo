...
INSTANCE SLOW_TIME_CHILD2(CFx_Base_Proto)
{
	// userstring 0: world  time scaler
	// userstring 1: player time scaler
	emFXTriggerDelay	= 0.5;						// achtung, zeitdauer ist hier skaliert mit dem time scaler
	emFXLifeSpan    	= 99999;						// achtung, zeitdauer ist hier skaliert mit dem time scaler
 	visName_S      		= "morph.fov";
 	userString[0]     	= "0.8";
 	userString[1]     	= "1.0";
 	userString[2]		= "140";
 	userString[3]		= "100";
	sfxID			= "JIBOWACKELDACKEL";
     	sfxisambient			= 1;
};
...
INSTANCE SPELLFX_IRRLICHT (CFX_BASE_PROTO)
{
	visname_s			= "IRRLICHT";
	visalpha			= 1;
	visalphablendfunc_s		= "ADD";
...
INSTANCE XM11_RAINBOWTRAIL_0 (CFx_Base_Proto) {	visname_S = "XM11_RAINBOWTRAIL_STRIPE_0"; emtrjmode_s = "FIXED"; };
INSTANCE XM11_RAINBOWTRAIL_1 (CFx_Base_Proto) {	visname_S = "XM11_RAINBOWTRAIL_STRIPE_1"; emtrjmode_s = "FIXED"; };
INSTANCE XM11_RAINBOWTRAIL_2 (CFx_Base_Proto) {	visname_S = "XM11_RAINBOWTRAIL_STRIPE_2"; emtrjmode_s = "FIXED"; };
INSTANCE XM11_RAINBOWTRAIL_3 (CFx_Base_Proto) {	visname_S = "XM11_RAINBOWTRAIL_STRIPE_3"; emtrjmode_s = "FIXED"; };
INSTANCE XM11_RAINBOWTRAIL_4 (CFx_Base_Proto) {	visname_S = "XM11_RAINBOWTRAIL_STRIPE_4"; emtrjmode_s = "FIXED"; };
INSTANCE XM11_RAINBOWTRAIL_5 (CFx_Base_Proto) {	visname_S = "XM11_RAINBOWTRAIL_STRIPE_5"; emtrjmode_s = "FIXED"; };

INSTANCE XM11_PRESENTSPAWNED (CFx_Base_Proto) {	visname_S = "XM11_PRESENTSPAWNED"; emtrjmode_s = "FIXED"; };